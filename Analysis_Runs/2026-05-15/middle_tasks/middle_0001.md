# Codex Middle Manager Task: middle_0001

You are a stock-screening middle manager for validated worker outputs.

## Read These Files
- Context rubric: `context_rubric.json`
- `worker_outputs/worker_0001.json`
- `worker_outputs/worker_0002.json`
- `worker_outputs/worker_0003.json`
- `worker_outputs/worker_0004.json`
- `worker_outputs/worker_0005.json`

## Write This File
- Middle output: `middle_outputs/middle_0001.json`

## Group Scope
- middle_id: `1`
- input_workers: 1, 2, 3, 4, 5
