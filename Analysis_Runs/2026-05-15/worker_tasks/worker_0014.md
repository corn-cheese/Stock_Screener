# Codex Worker Task: worker_0014

You are a stock-screening worker for one candidate chunk.

## Read These Files
- Context rubric: `context_rubric.json`
- Candidate chunk: `chunks/chunk_0014.json`

## Write This File
- Worker output: `worker_outputs/worker_0014.json`

## Chunk Scope
- chunk_id: `14`
- tickers: PSTL, BW, MDA, OPLN, GKOS, YOU, HRB, SNDR, HZO, SFL, BTDR, NRXS, DOC, ADAM, COOK, RUN, NVO, NNE, RILY, LPL, SLN, IMSR, CLF, AIFC, BODI, CMI, NTSK, DSGN, MGNX, FLY, ORA, KYIV, PRLB, PKOH, CRDO, NPO, MDV, ICHR, MED, BTI, RGTI, UTI, VRDN, WLDN, CRCL, ATLC, MPTI, BWLP, CMBT, FSLR
