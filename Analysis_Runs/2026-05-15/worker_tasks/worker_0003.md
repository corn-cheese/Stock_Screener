# Codex Worker Task: worker_0003

You are a stock-screening worker for one candidate chunk.

## Read These Files
- Context rubric: `context_rubric.json`
- Candidate chunk: `chunks/chunk_0003.json`

## Write This File
- Worker output: `worker_outputs/worker_0003.json`

## Chunk Scope
- chunk_id: `3`
- tickers: NVCR, TWLO, CNC, SLQT, STM, RUM, KEEL, WTI, SMTC, AESI, INV, MRDN, CD, CXDO, HOVR, SANM, RDZN, SLS, VICR, TORO, BB, TBI, LUNR, LQDA, OGN, CPIX, HUM, FTNT, RMAX, CTEV, COCO, GFS, ESPR, NGNE, SEZL, QCOM, FPS, DMRC, LIFE, DWSN, HUT, STX, AAON, USAR, WALD, ZIP, OSCR, MAAS, RFIL, FTRE
