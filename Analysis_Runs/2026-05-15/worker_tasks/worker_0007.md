# Codex Worker Task: worker_0007

You are a stock-screening worker for one candidate chunk.

## Read These Files
- Context rubric: `context_rubric.json`
- Candidate chunk: `chunks/chunk_0007.json`

## Write This File
- Worker output: `worker_outputs/worker_0007.json`

## Chunk Scope
- chunk_id: `7`
- tickers: DHX, BYFC, DRTS, NEXA, FLD, PRM, RNAC, GPRO, POWI, VSAT, OSG, KLIC, MWH, PWR, STAA, VSTS, QBTS, RDCM, RBRK, EGHT, NBR, TSEM, TDC, MDB, RAL, ADUR, PYXS, PLUG, EOSE, TTGT, RELY, GEO, P, MCHP, HYPR, TMCI, ASRT, CECO, VIAV, NVT, WSHP, S, DVA, LUD, FTK, SVC, EQ, GNRC, NUCL, DFDV
