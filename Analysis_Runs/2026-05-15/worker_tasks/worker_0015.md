# Codex Worker Task: worker_0015

You are a stock-screening worker for one candidate chunk.

## Read These Files
- Context rubric: `context_rubric.json`
- Candidate chunk: `chunks/chunk_0015.json`

## Write This File
- Worker output: `worker_outputs/worker_0015.json`

## Chunk Scope
- chunk_id: `15`
- tickers: LNTH, GDYN, GTE, RGP, GNLX, AVGO, JBL, CODI, HR, SATL, NKLR, SFM, SEPN, AAPL, OCC, SMTI, PII, STSS, SUNB, ELVA, MUSA, HP, CAT, SNX, CON, MOD, CMPR, HIW, AVR, INDV, PLXS, DY, IDR, XXI, PLGO, TENB, ESI, ARRY, PROF, RSSS, ADEA, AIRG
