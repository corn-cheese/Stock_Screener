# Codex Worker Task: worker_0008

You are a stock-screening worker for one candidate chunk.

## Read These Files
- Context rubric: `context_rubric.json`
- Candidate chunk: `chunks/chunk_0008.json`

## Write This File
- Worker output: `worker_outputs/worker_0008.json`

## Chunk Scope
- chunk_id: `8`
- tickers: SHLS, LVO, QMCO, WHWK, COHR, IESC, PNRG, MTRN, BLMN, NRXP, NWPX, SUPX, CLYM, SXC, LINC, PBT, AMRC, MOH, POAS, COHU, CLPT, SXT, BGIN, WTTR, TTI, ELV, RELL, AP, ZBAI, VRCA, STRZ, PL, SRTA, CVS, ALXO, XGN, TDOC, HNRG, KALU, DOMO, CERS, OKTA, VATE, AXSM, ARKO, LYTS, BWA, VRNS, ZS, MARA
